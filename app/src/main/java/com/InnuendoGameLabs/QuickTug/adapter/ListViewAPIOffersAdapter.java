 ...
 */
public class ListViewAPIOffersAdapter extends BaseAdapter {
    Context context;
    List<Offers> listItem;

    public ListViewAPIOffersAdapter(Context context,
                                         List<Offers> listItem) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_point.setText( ((int)(Double.parseDouble(viewItem.getPayout())))+"");
